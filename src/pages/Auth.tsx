...
// Google sign-in is temporarily disabled during the Supabase migration (the
// OAuth broker/callback is being re-registered). Email/password sign-in stays
// available. Flip this back to true to restore the "Continue with Google" button.
