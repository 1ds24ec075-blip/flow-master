 ...
 * so Tally's idempotency check catches the duplicate instead of booking the
 * voucher twice. Not cryptographic — it only has to avoid collisions across
 * one company's ledger and stock item names.
 */
